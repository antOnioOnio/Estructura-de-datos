 ...
 * 
 * Un objeto válido del TDA Fecha_Historica representa el valor
 * 
...
/**
  * @brief Operador = del TDA Fecha_Historica
  * @param fec de tipo Fecha_Historica que se asignara a otro TDA Fecha_Historica
  * 
  */


  Fecha_Historica &operator=(const Fecha_Historica& fec);
