...
/**
  ...
  *             
  */
  void operator+(const Cronologia& cro);
  ...
  * @return Devuelve una Fecha_Historica
  */

  Fecha_Historica eventosAnio(int anio);
...
/**
  ...
  */
  ...
  /**
  * @brief Operador = del TDA Cronologia
  * @param cro de tipo Cronologia que se asignara a otro TDA cronologia
  * 
  */
  Cronologia &operator=(const Cronologia& cro);
