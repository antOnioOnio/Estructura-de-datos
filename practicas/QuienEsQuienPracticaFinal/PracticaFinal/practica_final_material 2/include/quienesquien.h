...
public:
	...
	*/
	void eliminar_nodos_redundantes(bintree<Pregunta>& arbol , bintree<Pregunta>::node nodo);
  ...
  /**
   * @brief Funcion que suma la altura de todas las ramas del arbol
   * 
   * @param nodo 			el nodo a calcular la altura
   * @param altura    altura del nodo actual
   * @return int      la altura
   */
	int suma_alturas(bintree<Pregunta>::node nodo , int altura);
	...
	/**
	 * @brief Funcion para crear un subArbol a partir de la pregunta y de los personajes restantes
	 * 
	 * @param n 															nodo con el que se construye el subarbol
	 * @param numPregunta 										posicion del vector de atributos a escoger
	 * @param filas_restantes 								personajes restantes
	 * @return bintree<Pregunta> 							se devuelve el subarbol correspondiente
	 */
	bintree<Pregunta> crearSubarbol(bintree<Pregunta>::node n, int numPregunta, set<int> filas_restantes);

	/**
	 * @brief Devuelve el arbol principal
	 * 
	 * @return bintree<Pregunta> el arbol 
	 */
	bintree<Pregunta> getArbol();
 
  /**
   * @brief Elimina un personaje del arbol
   * 
   * @param nombre nombre a eli minar	
	 * 
   * @param nodo nodo del arbol a recorrer
   */
	void elimina_personaje(string nombre, bintree<Pregunta>::node nodo);

	/**
	 * @brief Funcion que devuelve las preguntas y respuesta que han sido formuladas a raiz de un nodo. Subir'a por el arbol de padre en padre.
	 * 
	 * @param nodo_actual nodo de la jugada actual.
	 */
	void preguntas_formuladas(bintree<Pregunta>::node nodo_actual);
