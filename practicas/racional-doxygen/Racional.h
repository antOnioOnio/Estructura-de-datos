...
/**
  ...
  * del conjunto de los n�meros racionales, compuestos por dos valores enteros
...
/**
  ...
  *
  * Un objeto v�lido @e rep del TDA Racional representa al valor
  *
  * (rep.num,rep.den)
  *
  */
...
/**
  ...
  * @return Asigna al objeto impl�cito el numero racional n/d
  * @pre d debe ser distinto de cero
  */
...
/**
  * @brief Imprime un racional en el formato "(n/d)", si puede ;
  * simplificar simplifica, si el denominador es 1 imprime solo numerador
  */
  void  print();
...
/**
  ...
  * @param r racional a dividir con el objeto implicito
  */
  Racional operator/(const Racional & r);
...
/**
  ...
  * @param r racional a sumar con el objeto impl�cito
  */
  void operator+=(const Racional &r);

/**
  * @brief Sobrecarga del operador ==
  * @param r racional a comparar con el objeto impl�cito
  * @return Devuelve 0 si este objeto es igual a r
  */
